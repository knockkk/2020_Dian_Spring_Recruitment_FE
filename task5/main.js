...
window.onload = function(){    
    ...
    var arrIcon = ['user.jpg','user1.jpg'];    
    var num = 0;     //控制头像改变    
    ...
    var message = document.getElementsByTagName('li');    
    ...
    send.onclick = function(){    
        ...
        if(text.value ==''){    
            ...
            content.innerHTML += '<li><img src="'+arrIcon[num]+'"><span><div>'+text.value+'</div><div><audio controls autoplay></div></audio></span></li>';    
